...
export const SET_APP_FORMDATA = '@APP/SET_APP_FORMDATA'
...
export const SET_MODALSUCCESS = '@MODAL/SET_MODALSUCCESS'
export const SET_GALLERY_MODAL = '@MODAL/SET_GALLERY_MODAL'